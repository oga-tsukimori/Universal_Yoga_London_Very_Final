...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    /*fun deleteCourseById(classId: Int) {
        val db = this.writableDatabase  // writableDatabase is needed for deletion
        db.execSQL("DELETE FROM $TABLE_NAME WHERE classId = $classId")
        db.close()
    }*/
}
